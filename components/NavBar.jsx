...
const NavBar = ({ darkmode, setDarkmode }) => {
  ...
  return (
    <div className="p-0 md:p-2 sticky top-0 z-50 bg-white   dark:bg-gray-900 shadow-lg ">
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16 dark:bg-gray-900">
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className="hidden md:flex">
            ...
            <li className=" cursor-pointer dark:text-white">
              <BsMoonFill onClick={() => setDarkmode(!darkmode)} size={30} />
            </li>
          </ul>
          {/* Hamburger Icon */}
          <div className="md:hidden text-green-800 flex items-">
            <CgMenuGridR onClick={handleNav} size={50} />
            <li className=" cursor-pointer dark:text-white pl-8">
              <BsMoonFill onClick={() => setDarkmode(!darkmode)} size={30} />
            </li>
          </div>
        </div>
        ...
        >
          <div>
            <div className="flex justify-between text-black dark:text-white p-4">
              <Link href="/">
                <a>
                  <Image src={Logo} width="187" height="132" alt="/" />
                </a>
              </Link>
            ...
            <ul className="uppercase">
              <Link href="/">
                <li
                  ...
                  className=" px-3 hover:underline text-2xl font-bold py-4 text-green-800 dark:text-white"
                >
                  Home
                </li>
              </Link>
