...
const HomeScreen = () => {
  return (
    ...
    <div className='flex flex-col md:flex-row w-full h-[500px] dark:bg-gray-900'>
      {/* Container */}
      <div className='max-w-[900px] mx-auto mt-auto  px-8 flex flex-col justify-center h-full'>
        <p className='text-blue-600 md:ml-16 text-2xl sm:text-4xl pb-4'>Hi, my name is</p>
        <h1 className='text-4xl md:ml-16 sm:text-7xl font-bold dark:text-blue-100 text-green-900 '>
          Abhishek Singh
        </h1>
        <p className='text-blue-600 text-2xl sm:text-4xl py-4  md:ml-16'>and i am a</p>
