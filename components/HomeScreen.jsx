  ...
  return (
    ...
    <div className='flex flex-col md:flex-row w-full h-[500px] dark:bg-gray-900'>
      ...
      <div className='max-w-[1000px] mx-auto mt-auto  px-8 flex flex-col justify-center h-full'>
        ...
        <p className='text-blue-600 text-2xl sm:text-7xl pb-4'>and i am a</p>
<h1 className='text-4xl sm:text-7xl font-bold dark:text-blue-100 text-green-900'><TypewriterEffect /></h1>
