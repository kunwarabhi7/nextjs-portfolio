...
const HomeScreen = () => {
  return (
    <div className='text-center p-4 dark:bg-gray-900'>
      ...
      <h2 className='font-bold py-3 dark:text-white '>Front End Web Dev</h2>
      <p className='text-gray-700 dark:text-white'>Build app using nextJS reactJS tailwind CSS, A freelancer and a gamer who codes . Also a passionate gymer</p>
